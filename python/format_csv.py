...
input_file = '../results/unloaded-teste-concorrencia-deterministico.txt'
...
with open('./datasets/unloaded-teste-concorrencia-deterministico.csv', 'w', newline='') as csvfile:
